...
$Script:I18N.es += @{
    'menu.optA' = 'Administracion de buzones (PIM / reenvio / compartidos)'
    'section.admin' = 'ADMINISTRACION DE BUZONES  ::  {0}'
    'adminMenu.opt1' = 'Verificar y solicitar roles PIM de Exchange'
    'adminMenu.opt2' = 'Configurar reenvio de correo'
    'adminMenu.opt3' = 'Buzones compartidos (convertir / permisos)'
    'cat.pim' = 'PIM'
    'section.pim' = 'PIM :: Verificar y activar roles de Exchange'
    'role.pimGovernance' = 'Un administrador debe conceder los permisos de Microsoft Graph (RoleManagement.ReadWrite.Directory, etc.) al menos una vez para esta app'
    'pim.manualAlt' = 'portal Entra ID (entra.microsoft.com) > Roles y administradores > Privileged Identity Management > Mis roles'
    'pim.moduleMissing' = 'Falta el modulo Microsoft.Graph (Authentication / Identity.Governance / Users).'
    'pim.connecting' = 'Conectando a Microsoft Graph (se abrira el login)...'
    'pim.connected' = 'Conectado a Microsoft Graph.'
    'pim.connectError' = 'No se pudo conectar: {0}'
    'pim.checkingFor' = 'Verificando roles PIM para {0}...'
    'pim.activeTitle' = '{0} rol(es) de Exchange ya ACTIVOS via PIM'
    'pim.noneTitle' = 'Sin roles de Exchange elegibles ni activos en PIM'
    'pim.noneRec' = 'Pide a un administrador que te asigne un rol elegible (p.ej. Exchange Administrator) en Privileged Identity Management.'
    'pim.allActive' = 'Todos tus roles elegibles de Exchange ya estan activos.'
    'pim.eligibleTitle' = 'Rol elegible (no activo): {0}'
    'pim.eligibleRec' = 'Puedes activarlo temporalmente para esta sesion de administracion.'
    'pim.askActivate' = '¿Solicitar activacion de estos roles ahora?'
    'pim.justificationPrompt' = 'justificacion para la activacion (requerida por PIM)'
    'pim.defaultJustification' = 'Activacion via Outlook Diagnostic Tool para tareas de soporte'
    'pim.durationPrompt' = 'duracion en horas (1-24, ENTER = 4)'
    'pim.confirmActivate' = 'Se solicitara ACTIVAR el rol "{0}" por {1} hora(s).'
    'pim.activationRequested' = 'Solicitud de activacion enviada para "{0}".'
    'pim.activationNote' = 'Si la politica del rol requiere aprobacion, tardara en reflejarse. Verifica en el portal Entra ID.'
    'pim.activationError' = 'No se pudo activar el rol: {0}'
    'pim.errorTitle' = 'Error al verificar roles PIM'
    'gap.pimHint' = 'Si usas PIM, prueba activarlo desde [A] Administracion > [1] Roles PIM.'
    'section.forwarding' = 'CONFIGURAR REENVIO DE CORREO  ::  {0}'
    'prompt.forwardTarget' = 'correo destino para el reenvio (SMTP)'
    'fwd2.manualAlt' = 'Centro de admin de Exchange > Destinatarios > Buzones > (usuario) > Reenvio de correo'
    'fwd2.current' = 'Reenvio actual: {0}  ·  conservar copia: {1}'
    'fwd2.askRemove' = '¿Quitar el reenvio existente en vez de configurar uno nuevo?'
    'fwd2.confirmRemove' = 'Se ELIMINARA el reenvio configurado en {0}.'
    'fwd2.removed' = 'Reenvio eliminado.'
    'fwd2.noTarget' = 'No se indico un destino. Cancelado.'
    'fwd2.askKeepCopy' = '¿Conservar una copia en el buzon original?'
    'fwd2.confirmSet' = 'Se configurara el reenvio de {0} hacia {1}.'
    'fwd2.set' = 'Reenvio configurado hacia {0}.'
    'fwd2.securityNote' = 'Verifica que el destino sea legitimo: el reenvio automatico es una tecnica comun de exfiltracion de correo.'
    'fwd2.error' = 'Error: {0}'
    'section.shared1' = 'BUZON COMPARTIDO :: Convertir tipo  ::  {0}'
    'shared1.manualAlt' = 'Centro de admin de Exchange > Destinatarios > Buzones > (usuario) > Tipo de buzon'
    'shared1.currentType' = 'Tipo actual: {0}'
    'shared1.askRevert' = '¿Revertir a buzon regular (necesitara licencia de nuevo)?'
    'shared1.confirmRevert' = 'Se convertira {0} de compartido a REGULAR.'
    'shared1.reverted' = 'Buzon convertido a regular.'
    'shared1.licenseNoteRevert' = 'Recuerda asignar una licencia de Exchange Online al buzon.'
    'shared1.licenseNote' = 'Nota: un buzon compartido no necesita licencia bajo 50GB; sobre eso, necesita licencia.'
    'shared1.confirmConvert' = 'Se convertira {0} a BUZON COMPARTIDO.'
    'shared1.converted' = 'Buzon convertido a compartido.'
    'shared1.sizeWarnNote' = 'Si supera 50GB, el buzon necesitara una licencia Exchange Online Plan 2 (o similar).'
    'shared1.error' = 'Error: {0}'
    'section.shared2' = 'BUZON COMPARTIDO :: Ver permisos  ::  {0}'
    'cat.sharedMbx' = 'Buzon compartido'
    'shared2.title' = 'Permisos actuales de {0}'
    'shared2.fullAccessHeader' = 'Acceso completo (Full Access):'
    'shared2.sendAsHeader' = 'Enviar como (Send As):'
    'shared2.sendOnBehalfHeader' = 'Enviar en nombre de (Send on Behalf):'
    'shared2.error' = 'Error al leer permisos: {0}'
    'section.shared3' = 'BUZON COMPARTIDO :: Otorgar acceso  ::  {0}'
    'section.shared4' = 'BUZON COMPARTIDO :: Revocar acceso  ::  {0}'
    'shared3.optFull' = 'Acceso completo (Full Access)'
    'shared3.optSendAs' = 'Enviar como (Send As)'
    'shared3.optOnBehalf' = 'Enviar en nombre de (Send on Behalf)'
    'shared3.kindPrompt' = 'tipo de permiso [1-3]'
    'prompt.delegate' = 'usuario delegado (UPN/SMTP)'
    'shared3.noDelegate' = 'No se indico un delegado. Cancelado.'
    'shared3.confirmFull' = 'Se otorgara ACCESO COMPLETO a {0} sobre {1}.'
    'shared3.fullGranted' = 'Acceso completo otorgado a {0}.'
    'shared3.confirmSendAs' = 'Se otorgara ENVIAR COMO a {0} sobre {1}.'
    'shared3.sendAsGranted' = 'Enviar como otorgado a {0}.'
    'shared3.confirmOnBehalf' = 'Se otorgara ENVIAR EN NOMBRE DE a {0} sobre {1}.'
    'shared3.onBehalfGranted' = 'Enviar en nombre de otorgado a {0}.'
    'shared3.error' = 'Error: {0}'
    'shared4.confirmFull' = 'Se REVOCARA el acceso completo de {0} sobre {1}.'
    'shared4.fullRevoked' = 'Acceso completo revocado a {0}.'
    'shared4.confirmSendAs' = 'Se REVOCARA enviar como de {0} sobre {1}.'
    'shared4.sendAsRevoked' = 'Enviar como revocado a {0}.'
    'shared4.confirmOnBehalf' = 'Se REVOCARA enviar en nombre de de {0} sobre {1}.'
    'shared4.onBehalfRevoked' = 'Enviar en nombre de revocado a {0}.'
    'section.sharedMenu' = 'BUZONES COMPARTIDOS  ::  buzon: {0}'
    'sharedMenu.opt1' = 'Convertir a/desde buzon compartido'
    'sharedMenu.opt2' = 'Ver permisos actuales'
    'sharedMenu.opt3' = 'Otorgar acceso a un delegado'
    'sharedMenu.opt4' = 'Revocar acceso de un delegado'
}
$Script:I18N.en += @{
    'menu.optA' = 'Mailbox administration (PIM / forwarding / shared)'
    'section.admin' = 'MAILBOX ADMINISTRATION  ::  {0}'
    'adminMenu.opt1' = 'Check and request Exchange PIM roles'
    'adminMenu.opt2' = 'Configure mail forwarding'
    'adminMenu.opt3' = 'Shared mailboxes (convert / permissions)'
    'cat.pim' = 'PIM'
    'section.pim' = 'PIM :: Check and activate Exchange roles'
    'role.pimGovernance' = 'An administrator must grant the Microsoft Graph permissions (RoleManagement.ReadWrite.Directory, etc.) at least once for this app'
    'pim.manualAlt' = 'Entra ID portal (entra.microsoft.com) > Roles and administrators > Privileged Identity Management > My roles'
    'pim.moduleMissing' = 'The Microsoft.Graph module is missing (Authentication / Identity.Governance / Users).'
    'pim.connecting' = 'Connecting to Microsoft Graph (sign-in will open)...'
    'pim.connected' = 'Connected to Microsoft Graph.'
    'pim.connectError' = 'Could not connect: {0}'
    'pim.checkingFor' = 'Checking PIM roles for {0}...'
    'pim.activeTitle' = '{0} Exchange role(s) already ACTIVE via PIM'
    'pim.noneTitle' = 'No eligible or active Exchange roles in PIM'
    'pim.noneRec' = 'Ask an administrator to assign you an eligible role (e.g. Exchange Administrator) in Privileged Identity Management.'
    'pim.allActive' = 'All your eligible Exchange roles are already active.'
    'pim.eligibleTitle' = 'Eligible role (not active): {0}'
    'pim.eligibleRec' = 'You can activate it temporarily for this admin session.'
    'pim.askActivate' = 'Request activation of these roles now?'
    'pim.justificationPrompt' = 'justification for the activation (required by PIM)'
    'pim.defaultJustification' = 'Activation via Outlook Diagnostic Tool for support tasks'
    'pim.durationPrompt' = 'duration in hours (1-24, ENTER = 4)'
    'pim.confirmActivate' = 'The role "{0}" will be ACTIVATED for {1} hour(s).'
    'pim.activationRequested' = 'Activation request sent for "{0}".'
    'pim.activationNote' = 'If the role policy requires approval, it will take time to reflect. Check the Entra ID portal.'
    'pim.activationError' = 'Could not activate the role: {0}'
    'pim.errorTitle' = 'Error checking PIM roles'
    'gap.pimHint' = 'If you use PIM, try activating it from [A] Administration > [1] PIM roles.'
    'section.forwarding' = 'CONFIGURE MAIL FORWARDING  ::  {0}'
    'prompt.forwardTarget' = 'destination address for forwarding (SMTP)'
    'fwd2.manualAlt' = 'Exchange admin center > Recipients > Mailboxes > (user) > Email forwarding'
    'fwd2.current' = 'Current forwarding: {0}  ·  keep a copy: {1}'
    'fwd2.askRemove' = 'Remove the existing forwarding instead of setting a new one?'
    'fwd2.confirmRemove' = 'The forwarding configured on {0} will be REMOVED.'
    'fwd2.removed' = 'Forwarding removed.'
    'fwd2.noTarget' = 'No destination provided. Cancelled.'
    'fwd2.askKeepCopy' = 'Keep a copy in the original mailbox?'
    'fwd2.confirmSet' = 'Forwarding for {0} will be set to {1}.'
    'fwd2.set' = 'Forwarding set to {0}.'
    'fwd2.securityNote' = 'Verify the destination is legitimate: auto-forwarding is a common mail-exfiltration technique.'
    'fwd2.error' = 'Error: {0}'
    'section.shared1' = 'SHARED MAILBOX :: Convert type  ::  {0}'
    'shared1.manualAlt' = 'Exchange admin center > Recipients > Mailboxes > (user) > Mailbox type'
    'shared1.currentType' = 'Current type: {0}'
    'shared1.askRevert' = 'Revert to a regular mailbox (will need a license again)?'
    'shared1.confirmRevert' = '{0} will be converted from shared to REGULAR.'
    'shared1.reverted' = 'Mailbox converted to regular.'
    'shared1.licenseNoteRevert' = 'Remember to assign an Exchange Online license to the mailbox.'
    'shared1.licenseNote' = 'Note: a shared mailbox does not need a license under 50GB; above that, it needs one.'
    'shared1.confirmConvert' = '{0} will be converted to a SHARED MAILBOX.'
    'shared1.converted' = 'Mailbox converted to shared.'
    'shared1.sizeWarnNote' = 'If it exceeds 50GB, the mailbox will need an Exchange Online Plan 2 license (or similar).'
    'shared1.error' = 'Error: {0}'
    'section.shared2' = 'SHARED MAILBOX :: View permissions  ::  {0}'
    'cat.sharedMbx' = 'Shared mailbox'
    'shared2.title' = 'Current permissions for {0}'
    'shared2.fullAccessHeader' = 'Full Access:'
    'shared2.sendAsHeader' = 'Send As:'
    'shared2.sendOnBehalfHeader' = 'Send on Behalf:'
    'shared2.error' = 'Error reading permissions: {0}'
    'section.shared3' = 'SHARED MAILBOX :: Grant access  ::  {0}'
    'section.shared4' = 'SHARED MAILBOX :: Revoke access  ::  {0}'
    'shared3.optFull' = 'Full Access'
    'shared3.optSendAs' = 'Send As'
    'shared3.optOnBehalf' = 'Send on Behalf'
    'shared3.kindPrompt' = 'permission type [1-3]'
    'prompt.delegate' = 'delegate user (UPN/SMTP)'
    'shared3.noDelegate' = 'No delegate provided. Cancelled.'
    'shared3.confirmFull' = 'FULL ACCESS will be granted to {0} on {1}.'
    'shared3.fullGranted' = 'Full Access granted to {0}.'
    'shared3.confirmSendAs' = 'SEND AS will be granted to {0} on {1}.'
    'shared3.sendAsGranted' = 'Send As granted to {0}.'
    'shared3.confirmOnBehalf' = 'SEND ON BEHALF will be granted to {0} on {1}.'
    'shared3.onBehalfGranted' = 'Send on Behalf granted to {0}.'
    'shared3.error' = 'Error: {0}'
    'shared4.confirmFull' = 'Full Access for {0} on {1} will be REVOKED.'
    'shared4.fullRevoked' = 'Full Access revoked for {0}.'
    'shared4.confirmSendAs' = 'Send As for {0} on {1} will be REVOKED.'
    'shared4.sendAsRevoked' = 'Send As revoked for {0}.'
    'shared4.confirmOnBehalf' = 'Send on Behalf for {0} on {1} will be REVOKED.'
    'shared4.onBehalfRevoked' = 'Send on Behalf revoked for {0}.'
    'section.sharedMenu' = 'SHARED MAILBOXES  ::  mailbox: {0}'
    'sharedMenu.opt1' = 'Convert to/from shared mailbox'
    'sharedMenu.opt2' = 'View current permissions'
    'sharedMenu.opt3' = 'Grant access to a delegate'
    'sharedMenu.opt4' = 'Revoke access from a delegate'
}
$Script:I18N.pt += @{
    'menu.optA' = 'Administracao de caixas (PIM / encaminhamento / compartilhadas)'
    'section.admin' = 'ADMINISTRACAO DE CAIXAS  ::  {0}'
    'adminMenu.opt1' = 'Verificar e solicitar funcoes PIM do Exchange'
    'adminMenu.opt2' = 'Configurar encaminhamento de e-mail'
    'adminMenu.opt3' = 'Caixas compartilhadas (converter / permissoes)'
    'cat.pim' = 'PIM'
    'section.pim' = 'PIM :: Verificar e ativar funcoes do Exchange'
    'role.pimGovernance' = 'Um administrador deve conceder as permissoes do Microsoft Graph (RoleManagement.ReadWrite.Directory, etc.) pelo menos uma vez para este aplicativo'
    'pim.manualAlt' = 'portal Entra ID (entra.microsoft.com) > Funcoes e administradores > Privileged Identity Management > Minhas funcoes'
    'pim.moduleMissing' = 'Falta o modulo Microsoft.Graph (Authentication / Identity.Governance / Users).'
    'pim.connecting' = 'Conectando ao Microsoft Graph (o login sera aberto)...'
    'pim.connected' = 'Conectado ao Microsoft Graph.'
    'pim.connectError' = 'Nao foi possivel conectar: {0}'
    'pim.checkingFor' = 'Verificando funcoes PIM para {0}...'
    'pim.activeTitle' = '{0} funcao(oes) do Exchange ja ATIVAS via PIM'
    'pim.noneTitle' = 'Nenhuma funcao do Exchange elegivel ou ativa no PIM'
    'pim.noneRec' = 'Peca a um administrador para atribuir uma funcao elegivel (ex: Exchange Administrator) no Privileged Identity Management.'
    'pim.allActive' = 'Todas as suas funcoes elegiveis do Exchange ja estao ativas.'
    'pim.eligibleTitle' = 'Funcao elegivel (nao ativa): {0}'
    'pim.eligibleRec' = 'Voce pode ativa-la temporariamente para esta sessao de administracao.'
    'pim.askActivate' = 'Solicitar ativacao destas funcoes agora?'
    'pim.justificationPrompt' = 'justificativa para a ativacao (exigida pelo PIM)'
    'pim.defaultJustification' = 'Ativacao via Outlook Diagnostic Tool para tarefas de suporte'
    'pim.durationPrompt' = 'duracao em horas (1-24, ENTER = 4)'
    'pim.confirmActivate' = 'A funcao "{0}" sera ATIVADA por {1} hora(s).'
    'pim.activationRequested' = 'Solicitacao de ativacao enviada para "{0}".'
    'pim.activationNote' = 'Se a politica da funcao exigir aprovacao, levara tempo para refletir. Verifique no portal Entra ID.'
    'pim.activationError' = 'Nao foi possivel ativar a funcao: {0}'
    'pim.errorTitle' = 'Erro ao verificar funcoes PIM'
    'gap.pimHint' = 'Se voce usa PIM, tente ativa-lo em [A] Administracao > [1] Funcoes PIM.'
    'section.forwarding' = 'CONFIGURAR ENCAMINHAMENTO DE E-MAIL  ::  {0}'
    'prompt.forwardTarget' = 'endereco de destino para o encaminhamento (SMTP)'
    'fwd2.manualAlt' = 'Centro de admin do Exchange > Destinatarios > Caixas de correio > (usuario) > Encaminhamento de e-mail'
    'fwd2.current' = 'Encaminhamento atual: {0}  ·  manter copia: {1}'
    'fwd2.askRemove' = 'Remover o encaminhamento existente em vez de configurar um novo?'
    'fwd2.confirmRemove' = 'O encaminhamento configurado em {0} sera REMOVIDO.'
    'fwd2.removed' = 'Encaminhamento removido.'
    'fwd2.noTarget' = 'Nenhum destino informado. Cancelado.'
    'fwd2.askKeepCopy' = 'Manter uma copia na caixa original?'
    'fwd2.confirmSet' = 'O encaminhamento de {0} sera configurado para {1}.'
    'fwd2.set' = 'Encaminhamento configurado para {0}.'
    'fwd2.securityNote' = 'Verifique se o destino e legitimo: o encaminhamento automatico e uma tecnica comum de exfiltracao de e-mail.'
    'fwd2.error' = 'Erro: {0}'
    'section.shared1' = 'CAIXA COMPARTILHADA :: Converter tipo  ::  {0}'
    'shared1.manualAlt' = 'Centro de admin do Exchange > Destinatarios > Caixas de correio > (usuario) > Tipo de caixa'
    'shared1.currentType' = 'Tipo atual: {0}'
    'shared1.askRevert' = 'Reverter para caixa regular (precisara de licenca novamente)?'
    'shared1.confirmRevert' = '{0} sera convertida de compartilhada para REGULAR.'
    'shared1.reverted' = 'Caixa convertida para regular.'
    'shared1.licenseNoteRevert' = 'Lembre-se de atribuir uma licenca do Exchange Online a caixa.'
    'shared1.licenseNote' = 'Nota: uma caixa compartilhada nao precisa de licenca abaixo de 50GB; acima disso, precisa.'
    'shared1.confirmConvert' = '{0} sera convertida em CAIXA COMPARTILHADA.'
    'shared1.converted' = 'Caixa convertida para compartilhada.'
    'shared1.sizeWarnNote' = 'Se exceder 50GB, a caixa precisara de uma licenca Exchange Online Plan 2 (ou similar).'
    'shared1.error' = 'Erro: {0}'
    'section.shared2' = 'CAIXA COMPARTILHADA :: Ver permissoes  ::  {0}'
    'cat.sharedMbx' = 'Caixa compartilhada'
    'shared2.title' = 'Permissoes atuais de {0}'
    'shared2.fullAccessHeader' = 'Acesso total (Full Access):'
    'shared2.sendAsHeader' = 'Enviar como (Send As):'
    'shared2.sendOnBehalfHeader' = 'Enviar em nome de (Send on Behalf):'
    'shared2.error' = 'Erro ao ler permissoes: {0}'
    'section.shared3' = 'CAIXA COMPARTILHADA :: Conceder acesso  ::  {0}'
    'section.shared4' = 'CAIXA COMPARTILHADA :: Revogar acesso  ::  {0}'
    'shared3.optFull' = 'Acesso total (Full Access)'
    'shared3.optSendAs' = 'Enviar como (Send As)'
    'shared3.optOnBehalf' = 'Enviar em nome de (Send on Behalf)'
    'shared3.kindPrompt' = 'tipo de permissao [1-3]'
    'prompt.delegate' = 'usuario delegado (UPN/SMTP)'
    'shared3.noDelegate' = 'Nenhum delegado informado. Cancelado.'
    'shared3.confirmFull' = 'ACESSO TOTAL sera concedido a {0} em {1}.'
    'shared3.fullGranted' = 'Acesso total concedido a {0}.'
    'shared3.confirmSendAs' = 'ENVIAR COMO sera concedido a {0} em {1}.'
    'shared3.sendAsGranted' = 'Enviar como concedido a {0}.'
    'shared3.confirmOnBehalf' = 'ENVIAR EM NOME DE sera concedido a {0} em {1}.'
    'shared3.onBehalfGranted' = 'Enviar em nome de concedido a {0}.'
    'shared3.error' = 'Erro: {0}'
    'shared4.confirmFull' = 'O acesso total de {0} em {1} sera REVOGADO.'
    'shared4.fullRevoked' = 'Acesso total revogado para {0}.'
    'shared4.confirmSendAs' = 'Enviar como de {0} em {1} sera REVOGADO.'
    'shared4.sendAsRevoked' = 'Enviar como revogado para {0}.'
    'shared4.confirmOnBehalf' = 'Enviar em nome de de {0} em {1} sera REVOGADO.'
    'shared4.onBehalfRevoked' = 'Enviar em nome de revogado para {0}.'
    'section.sharedMenu' = 'CAIXAS COMPARTILHADAS  ::  caixa: {0}'
    'sharedMenu.opt1' = 'Converter para/de caixa compartilhada'
    'sharedMenu.opt2' = 'Ver permissoes atuais'
    'sharedMenu.opt3' = 'Conceder acesso a um delegado'
    'sharedMenu.opt4' = 'Revogar acesso de um delegado'
}
...
function Show-CmdletGapWarning {
    ...
    Write-Host (Ink "   $(T 'gap.pimHint')" 'Dark')
...
# =====================================================================================
#  ADMINISTRACION  ::  PIM / reenvio de correo / buzones compartidos
# =====================================================================================

# --- Conexion a Microsoft Graph (para PIM) -------------------------------------------
function Connect-Pim {
    ...
    if (-not (Get-Module -ListAvailable -Name Microsoft.Graph.Authentication)) {
        Write-Host (Ink "   [x] $(T 'pim.moduleMissing')" 'Red')
        Write-Host (Ink '       Install-Module Microsoft.Graph.Authentication, Microsoft.Graph.Identity.Governance, Microsoft.Graph.Users -Scope CurrentUser' 'Gray')
        return $false
    }
    try {
        Write-Host (Ink "   [~] $(T 'pim.connecting')" 'Cyan')
        Import-Module Microsoft.Graph.Authentication -ErrorAction Stop
        Connect-MgGraph -Scopes 'RoleManagement.ReadWrite.Directory','RoleEligibilitySchedule.ReadWrite.Directory','RoleAssignmentSchedule.ReadWrite.Directory','User.Read.All' -NoWelcome -ErrorAction Stop
        Write-Host (Ink "   [+] $(T 'pim.connected')" 'Green')
        return $true
    } catch {
        Write-Host (Ink "   [x] $(T 'pim.connectError' @($_.Exception.Message))" 'Red')
        return $false
    }
}

# --- ADMIN 1: Verificar y solicitar roles PIM de Exchange ----------------------------
function Request-PimActivation {
    param($TargetUser, $Role)
    $roleName = $Role.RoleDefinition.DisplayName
    Write-Host ''
    Write-Host (Ink "   ▶ $roleName" 'Cyan' -Bold)
    $justification = Read-Prompt (T 'pim.justificationPrompt')
    if (-not $justification) { $justification = T 'pim.defaultJustification' }
    $hoursStr = Read-Prompt (T 'pim.durationPrompt')
    $hours = if ($hoursStr -as [int]) { [int]$hoursStr } else { 4 }
    if ($hours -lt 1) { $hours = 1 }
    if ($hours -gt 24) { $hours = 24 }

    if (-not (Confirm-Typed (T 'pim.confirmActivate' @($roleName, $hours)) (T 'confirm.word.activate'))) { return }
    ...
    try {
        ...
        Write-AuditLog "PIM activate  =>  role='$roleName'  user=$($TargetUser.UserPrincipalName)  hours=$hours"
        Write-Host (Ink "   [+] $(T 'pim.activationRequested' @($roleName))" 'Green')
        Write-Host (Ink "   $(T 'pim.activationNote')" 'Gray')
    } catch {
        Write-Host (Ink "   [x] $(T 'pim.activationError' @($_.Exception.Message))" 'Red')
    }
}

function Invoke-PimCheck {
    Write-Section (T 'section.pim') 'Blue'
    if (-not (Connect-Pim)) { return }
    $missing = Test-RequiredCmdlets -Names 'Get-MgRoleManagementDirectoryRoleEligibilitySchedule','New-MgRoleManagementDirectoryRoleAssignmentScheduleRequest','Get-MgUser'
    if ($missing.Count -gt 0) {
        Show-CmdletGapWarning -Missing $missing -RoleHint (T 'role.pimGovernance') -ManualAlternative (T 'pim.manualAlt')
        return
    }
    try {
        $ctx = Get-MgContext -ErrorAction Stop
        $me = Get-MgUser -UserId $ctx.Account -ErrorAction Stop
        Write-Host (Ink "   $(T 'pim.checkingFor' @($me.UserPrincipalName))" 'Gray')

        $eligible = @(Get-MgRoleManagementDirectoryRoleEligibilitySchedule -Filter "principalId eq '$($me.Id)'" -ExpandProperty RoleDefinition -ErrorAction Stop)
        $active   = @(Get-MgRoleManagementDirectoryRoleAssignmentSchedule -Filter "principalId eq '$($me.Id)'" -ExpandProperty RoleDefinition -ErrorAction SilentlyContinue)

        $exEligible = @($eligible | Where-Object { $_.RoleDefinition.DisplayName -match 'Exchange' })
        $exActive   = @($active   | Where-Object { $_.RoleDefinition.DisplayName -match 'Exchange' })

        if ($exActive.Count -gt 0) {
            $lines = $exActive | ForEach-Object { "· $($_.RoleDefinition.DisplayName)" }
            Add-Finding (T 'cat.pim') 'OK' (T 'pim.activeTitle' @($exActive.Count)) ($lines -join "`n")
        }

        if ($exEligible.Count -eq 0 -and $exActive.Count -eq 0) {
            Add-Finding (T 'cat.pim') 'WARN' (T 'pim.noneTitle') '' (T 'pim.noneRec')
            return
        }

        $toActivate = @($exEligible | Where-Object {
            $rdId = $_.RoleDefinitionId
            -not (@($exActive | Where-Object { $_.RoleDefinitionId -eq $rdId })).Count
        })

        if ($toActivate.Count -eq 0) {
            Write-Host (Ink "   [~] $(T 'pim.allActive')" 'Green')
            return
        }

        foreach ($role in $toActivate) {
            Add-Finding (T 'cat.pim') 'INFO' (T 'pim.eligibleTitle' @($role.RoleDefinition.DisplayName)) '' (T 'pim.eligibleRec')
        }

        if (Read-YesNo 'pim.askActivate') {
            foreach ($role in $toActivate) {
                Request-PimActivation -TargetUser $me -Role $role
            }
        }
    } catch {
        Add-Finding (T 'cat.pim') 'WARN' (T 'pim.errorTitle') $_.Exception.Message
    }
}

# --- ADMIN 2: Configurar reenvio de correo -------------------------------------------
function Invoke-ConfigureForwarding {
    param([string]$Mbx)
    Write-Section (T 'section.forwarding' @($Mbx)) 'Blue'
    if (-not (Assert-RemediationReady -Mbx $Mbx)) { return }
    $missing = Test-RequiredCmdlets -Names 'Set-Mailbox'
    if ($missing.Count -gt 0) {
        Show-CmdletGapWarning -Missing $missing -RoleHint (T 'role.recipientMgmt') -ManualAlternative (T 'fwd2.manualAlt')
        return
    }
    try {
        $mb = Get-Mailbox -Identity $Mbx -ErrorAction Stop
        $currentFwd = if ($mb.ForwardingSmtpAddress) { "$($mb.ForwardingSmtpAddress)" } elseif ($mb.ForwardingAddress) { "$($mb.ForwardingAddress)" } else { $null }
        Write-Host (Ink "   $(T 'fwd2.current' @($(if($currentFwd){$currentFwd}else{T 'move2.none'}), $mb.DeliverToMailboxAndForward))" 'Gray')
        Write-Host ''

        if ($currentFwd) {
            if (Read-YesNo 'fwd2.askRemove') {
                if (Confirm-Typed (T 'fwd2.confirmRemove' @($Mbx)) (T 'confirm.word.apply')) {
                    Set-Mailbox -Identity $Mbx -ForwardingSmtpAddress $null -ForwardingAddress $null -ErrorAction Stop
                    Write-AuditLog "Set-Mailbox -ForwardingSmtpAddress `$null -ForwardingAddress `$null  =>  $Mbx"
                    Write-Host (Ink "   [+] $(T 'fwd2.removed')" 'Green')
                }
                return
            }
        }

        $target = Read-Prompt (T 'prompt.forwardTarget')
        if (-not $target) { Write-Host (Ink "   [x] $(T 'fwd2.noTarget')" 'Red'); return }
        $keepCopy = Read-YesNo 'fwd2.askKeepCopy'

        if (-not (Confirm-Typed (T 'fwd2.confirmSet' @($Mbx, $target)) (T 'confirm.word.apply'))) { return }

        Set-Mailbox -Identity $Mbx -ForwardingSmtpAddress $target -DeliverToMailboxAndForward $keepCopy -ErrorAction Stop
        Write-AuditLog "Set-Mailbox -ForwardingSmtpAddress '$target' -DeliverToMailboxAndForward $keepCopy  =>  $Mbx"
        Write-Host (Ink "   [+] $(T 'fwd2.set' @($target))" 'Green')
        Write-Host (Ink "   $(T 'fwd2.securityNote')" 'Yellow')
    } catch {
        Write-Host (Ink "   [x] $(T 'fwd2.error' @($_.Exception.Message))" 'Red')
    }
}

# --- ADMIN 3a: Convertir buzon <-> compartido ----------------------------------------
function Invoke-ConvertSharedMailbox {
    param([string]$Mbx)
    Write-Section (T 'section.shared1' @($Mbx)) 'Blue'
    if (-not (Assert-RemediationReady -Mbx $Mbx)) { return }
    $missing = Test-RequiredCmdlets -Names 'Set-Mailbox'
    if ($missing.Count -gt 0) {
        Show-CmdletGapWarning -Missing $missing -RoleHint (T 'role.recipientMgmt') -ManualAlternative (T 'shared1.manualAlt')
        return
    }
    try {
        $mb = Get-Mailbox -Identity $Mbx -ErrorAction Stop
        Write-Host (Ink "   $(T 'shared1.currentType' @($mb.RecipientTypeDetails))" 'Gray')

        if ($mb.RecipientTypeDetails -eq 'SharedMailbox') {
            if (Read-YesNo 'shared1.askRevert') {
                if (-not (Confirm-Typed (T 'shared1.confirmRevert' @($Mbx)) (T 'confirm.word.apply'))) { return }
                Set-Mailbox -Identity $Mbx -Type Regular -ErrorAction Stop
                Write-AuditLog "Set-Mailbox -Type Regular  =>  $Mbx"
                Write-Host (Ink "   [+] $(T 'shared1.reverted')" 'Green')
                Write-Host (Ink "   $(T 'shared1.licenseNoteRevert')" 'Yellow')
            }
            return
        }

        Write-Host (Ink "   $(T 'shared1.licenseNote')" 'Gray')
        if (-not (Confirm-Typed (T 'shared1.confirmConvert' @($Mbx)) (T 'confirm.word.apply'))) { return }
        Set-Mailbox -Identity $Mbx -Type Shared -ErrorAction Stop
        Write-AuditLog "Set-Mailbox -Type Shared  =>  $Mbx"
        Write-Host (Ink "   [+] $(T 'shared1.converted')" 'Green')
        Write-Host (Ink "   $(T 'shared1.sizeWarnNote')" 'Yellow')
    } catch {
        Write-Host (Ink "   [x] $(T 'shared1.error' @($_.Exception.Message))" 'Red')
    }
}

# --- ADMIN 3b: Ver permisos actuales del buzon compartido ----------------------------
function Show-SharedMailboxPermissions {
    param([string]$Mbx)
    Write-Section (T 'section.shared2' @($Mbx)) 'Cyan'
    if (-not (Assert-RemediationReady -Mbx $Mbx)) { return }
    $missing = Test-RequiredCmdlets -Names 'Get-MailboxPermission','Get-RecipientPermission'
    if ($missing.Count -gt 0) {
        Show-CmdletGapWarning -Missing $missing -RoleHint (T 'role.recipientMgmt') -ManualAlternative (T 'shared1.manualAlt')
        return
    }
    try {
        $full = @(Get-MailboxPermission -Identity $Mbx -ErrorAction Stop | Where-Object {
            $_.User -notmatch 'NT AUTHORITY|S-1-5' -and -not $_.IsInherited -and $_.AccessRights -contains 'FullAccess'
        })
        $sendAs = @(Get-RecipientPermission -Identity $Mbx -ErrorAction SilentlyContinue | Where-Object { $_.Trustee -notmatch 'NT AUTHORITY|S-1-5' })
        $mb = Get-Mailbox -Identity $Mbx -ErrorAction Stop
        $onBehalf = @($mb.GrantSendOnBehalfTo)

        $noneTxt = T 'move2.none'
        $lines = @()
        $lines += (T 'shared2.fullAccessHeader')
        $lines += @(if ($full.Count -gt 0) { $full | ForEach-Object { "  · $($_.User)" } } else { "  ($noneTxt)" })
        $lines += (T 'shared2.sendAsHeader')
        $lines += @(if ($sendAs.Count -gt 0) { $sendAs | ForEach-Object { "  · $($_.Trustee)" } } else { "  ($noneTxt)" })
        $lines += (T 'shared2.sendOnBehalfHeader')
        $lines += @(if ($onBehalf.Count -gt 0) { $onBehalf | ForEach-Object { "  · $_" } } else { "  ($noneTxt)" })

        Add-Finding (T 'cat.sharedMbx') 'INFO' (T 'shared2.title' @($Mbx)) ($lines -join "`n")
    } catch {
        Write-Host (Ink "   [x] $(T 'shared2.error' @($_.Exception.Message))" 'Red')
    }
}

# --- ADMIN 3c: Otorgar acceso a un delegado ------------------------------------------
function Grant-SharedMailboxAccess {
    param([string]$Mbx)
    Write-Section (T 'section.shared3' @($Mbx)) 'Purple'
    if (-not (Assert-RemediationReady -Mbx $Mbx)) { return }
    $missing = Test-RequiredCmdlets -Names 'Add-MailboxPermission','Add-RecipientPermission','Set-Mailbox'
    if ($missing.Count -gt 0) {
        Show-CmdletGapWarning -Missing $missing -RoleHint (T 'role.recipientMgmt') -ManualAlternative (T 'shared1.manualAlt')
        return
    }
    Write-Host (Ink "   [1] $(T 'shared3.optFull')" 'Cyan')
    Write-Host (Ink "   [2] $(T 'shared3.optSendAs')" 'Cyan')
    Write-Host (Ink "   [3] $(T 'shared3.optOnBehalf')" 'Cyan')
    $kind = Read-Prompt (T 'shared3.kindPrompt')
    $delegate = Read-Prompt (T 'prompt.delegate')
    if (-not $delegate) { Write-Host (Ink "   [x] $(T 'shared3.noDelegate')" 'Red'); return }

    switch ($kind) {
        '1' {
            if (-not (Confirm-Typed (T 'shared3.confirmFull' @($delegate, $Mbx)) (T 'confirm.word.apply'))) { return }
            try {
                Add-MailboxPermission -Identity $Mbx -User $delegate -AccessRights FullAccess -InheritanceType All -AutoMapping $true -ErrorAction Stop | Out-Null
                Write-AuditLog "Add-MailboxPermission FullAccess  =>  $Mbx  user=$delegate"
                Write-Host (Ink "   [+] $(T 'shared3.fullGranted' @($delegate))" 'Green')
            } catch { Write-Host (Ink "   [x] $(T 'shared3.error' @($_.Exception.Message))" 'Red') }
        }
        '2' {
            if (-not (Confirm-Typed (T 'shared3.confirmSendAs' @($delegate, $Mbx)) (T 'confirm.word.apply'))) { return }
            try {
                Add-RecipientPermission -Identity $Mbx -Trustee $delegate -AccessRights SendAs -Confirm:$false -ErrorAction Stop | Out-Null
                Write-AuditLog "Add-RecipientPermission SendAs  =>  $Mbx  user=$delegate"
                Write-Host (Ink "   [+] $(T 'shared3.sendAsGranted' @($delegate))" 'Green')
            } catch { Write-Host (Ink "   [x] $(T 'shared3.error' @($_.Exception.Message))" 'Red') }
        }
        '3' {
            if (-not (Confirm-Typed (T 'shared3.confirmOnBehalf' @($delegate, $Mbx)) (T 'confirm.word.apply'))) { return }
            try {
                Set-Mailbox -Identity $Mbx -GrantSendOnBehalfTo @{Add=$delegate} -ErrorAction Stop
                Write-AuditLog "Set-Mailbox -GrantSendOnBehalfTo Add  =>  $Mbx  user=$delegate"
                Write-Host (Ink "   [+] $(T 'shared3.onBehalfGranted' @($delegate))" 'Green')
            } catch { Write-Host (Ink "   [x] $(T 'shared3.error' @($_.Exception.Message))" 'Red') }
        }
        default { Write-Host (Ink "   [x] $(T 'remMenu.invalidOption')" 'Red') }
    }
}

# --- ADMIN 3d: Revocar acceso de un delegado -----------------------------------------
function Revoke-SharedMailboxAccess {
    param([string]$Mbx)
    Write-Section (T 'section.shared4' @($Mbx)) 'Red'
    if (-not (Assert-RemediationReady -Mbx $Mbx)) { return }
    $missing = Test-RequiredCmdlets -Names 'Remove-MailboxPermission','Remove-RecipientPermission','Set-Mailbox'
    if ($missing.Count -gt 0) {
        Show-CmdletGapWarning -Missing $missing -RoleHint (T 'role.recipientMgmt') -ManualAlternative (T 'shared1.manualAlt')
        return
    }
    ...
    switch ($kind) {
        '1' {
            if (-not (Confirm-Typed (T 'shared4.confirmFull' @($delegate, $Mbx)) (T 'confirm.word.apply'))) { return }
            try {
                Remove-MailboxPermission -Identity $Mbx -User $delegate -AccessRights FullAccess -Confirm:$false -ErrorAction Stop | Out-Null
                Write-AuditLog "Remove-MailboxPermission FullAccess  =>  $Mbx  user=$delegate"
                Write-Host (Ink "   [+] $(T 'shared4.fullRevoked' @($delegate))" 'Green')
            } catch { Write-Host (Ink "   [x] $(T 'shared3.error' @($_.Exception.Message))" 'Red') }
        }
        '2' {
            if (-not (Confirm-Typed (T 'shared4.confirmSendAs' @($delegate, $Mbx)) (T 'confirm.word.apply'))) { return }
            try {
                Remove-RecipientPermission -Identity $Mbx -Trustee $delegate -AccessRights SendAs -Confirm:$false -ErrorAction Stop | Out-Null
                Write-AuditLog "Remove-RecipientPermission SendAs  =>  $Mbx  user=$delegate"
                Write-Host (Ink "   [+] $(T 'shared4.sendAsRevoked' @($delegate))" 'Green')
            } catch { Write-Host (Ink "   [x] $(T 'shared3.error' @($_.Exception.Message))" 'Red') }
        }
        '3' {
            if (-not (Confirm-Typed (T 'shared4.confirmOnBehalf' @($delegate, $Mbx)) (T 'confirm.word.apply'))) { return }
            try {
                Set-Mailbox -Identity $Mbx -GrantSendOnBehalfTo @{Remove=$delegate} -ErrorAction Stop
                Write-AuditLog "Set-Mailbox -GrantSendOnBehalfTo Remove  =>  $Mbx  user=$delegate"
                Write-Host (Ink "   [+] $(T 'shared4.onBehalfRevoked' @($delegate))" 'Green')
            } catch { Write-Host (Ink "   [x] $(T 'shared3.error' @($_.Exception.Message))" 'Red') }
        }
        default { Write-Host (Ink "   [x] $(T 'remMenu.invalidOption')" 'Red') }
    }
...
# --- Submenu: buzones compartidos ----------------------------------------------------
function Invoke-SharedMailboxMenu {
    param([string]$Mbx)
    $back = $false
    while (-not $back) {
        Write-Section (T 'section.sharedMenu' @($(if($Mbx){$Mbx}else{T 'menu.undefined'}))) 'Purple'
        $sopts = @(
            @('1',(T 'sharedMenu.opt1'),'Blue'),
            @('2',(T 'sharedMenu.opt2'),'Cyan'),
            @('3',(T 'sharedMenu.opt3'),'Green'),
            @('4',(T 'sharedMenu.opt4'),'Red'),
            @('0',(T 'remMenu.opt0'),'Gray')
        )
        foreach ($o in $sopts) {
            Write-Host (Ink "   [$($o[0])] " $o[2] -Bold) -NoNewline
        ...
        $c = Read-Prompt (T 'prompt.remediationAction')
        switch ($c) {
            '1' { Invoke-ConvertSharedMailbox -Mbx $Mbx }
            '2' { Show-SharedMailboxPermissions -Mbx $Mbx; Show-Summary }
            '3' { Grant-SharedMailboxAccess -Mbx $Mbx }
            '4' { Revoke-SharedMailboxAccess -Mbx $Mbx }
            '0' { $back = $true }
            default { Write-Host (Ink "   $(T 'remMenu.invalidOption')" 'Red') }
        }
        if (-not $back) {
...
# --- Submenu: administracion de buzones (top-level) ----------------------------------
function Invoke-AdminMenu {
    param([string]$Mbx)
    $back = $false
    while (-not $back) {
        Write-Section (T 'section.admin' @($(if($Mbx){$Mbx}else{T 'menu.undefined'}))) 'Blue'
        $aopts = @(
            @('1',(T 'adminMenu.opt1'),'Blue'),
            @('2',(T 'adminMenu.opt2'),'Cyan'),
            @('3',(T 'adminMenu.opt3'),'Purple'),
            @('0',(T 'remMenu.opt0'),'Gray')
        )
        foreach ($o in $aopts) {
            Write-Host (Ink "   [$($o[0])] " $o[2] -Bold) -NoNewline
        ...
        switch ($c) {
            '1' { Invoke-PimCheck }
            '2' { Invoke-ConfigureForwarding -Mbx $Mbx }
            '3' { Invoke-SharedMailboxMenu -Mbx $Mbx }
            '0' { $back = $true }
            default { Write-Host (Ink "   $(T 'remMenu.invalidOption')" 'Red') }
        }
        if (-not $back) {
...
while ($run) {
    ...
    switch ($choice) {
        ...
        'A' { Invoke-AdminMenu -Mbx $Script:SessionInfo.Mailbox }
        '0' { $run = $false }
        default { Write-Host (Ink "   $(T 'main.invalidOption')" 'Red') }
    }
    if ($run -and $choice -in '1','2','3','5','8','A') {
        if ($choice -notin '8','A') {
            Write-Host ''
